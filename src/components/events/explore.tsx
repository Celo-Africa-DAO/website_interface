                ...
                >
                  <Card className="bg-transparent border-none flex flex-col md:flex-row justify-between items-center h-full">
                    <CardContent className="w-full md:w-1/4 h-full flex flex-col md:flex-row gap-2 md:gap-0   ">
                      <CardDescription className="font-gt-alpina  p-4 justify-between items-center block md:hidden font-bold text-sm">
                        UPCOMING
                      </CardDescription>
            ...
            <CarouselContent className="ml-0">
              {events.map((element) => (
                ...
                >
                  <Card className="bg-transparent border-none flex flex-col md:flex-row justify-between items-center h-full">
                    <CardContent className="w-full md:w-1/4 h-full flex flex-col md:flex-row gap-2 md:gap-0   ">
                      <CardDescription className="font-gt-alpina  p-4 justify-between items-center block md:hidden  text-sm font-bold">
                        PAST
                      </CardDescription>
