...
const PastEventCard: React.FC<PastEventCardProps> = ({ pastevent, onNext }) => (
  <div className="px-32">
    <h1 className="md:mb-[60px] mb-[45px] text-black font-extralight pt-16 font-gt-alpina italic text-[36px] md:text-[36px] leading-[45px] md:leading-[80px]">
      Past Event Video
    </h1>
    <div className="w-full h-1/4 flex md:flex-row flex-col justify-between items-center border-t-2 p-14 border-b-2 border-gray-500 mt-4">
      ...
      <span className="flex md:justify-normal self-end md:self-auto h-[120px] w-[300px] bg-[#e9ecef]">
        <IoLogoYoutube
          className="hidden md:block w-[50px] h-[50px] my-10 ml-32"
          color="red"
          onClick={onNext}
        />
      </span>
