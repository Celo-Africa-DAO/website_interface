          ...
          <div className="flex flex-col md:flex-row justify-between  md:items-center gap-4 sm:gap-20">
            ...
            <div className="w-[80%] sm:w-2/4]">
              ...
              <div className="flex flex-row gap- sm:gap-6">
                <Button onClick={handleJoin} className=" rounded-[100px] bg-Celo-AD-yellow hover:bg-Celo-AD-yellow/75 text-[#090808] hover:bg-Celo-AD-yellow px-6 sm:px-10  w-fit mt-4 text-xs  sm:text-base">
                  Join the cohort
                </Button>
                <Button onClick={handleLearnMore} className="bg-trasparent px-8 ms:px-10 w-fit mt-4 hover:bg-transparent text-xs  sm:text-base">
                  Learn More{" "}
                  <img
