...
const Hero = () => {
  return (
    <div className="bg-cover bg-center bg-no-repeat bg-[url('/HeroImage.png')] h-[820px] object-cover bg-gray-700 text-gray-50">
      <div className="pt-32 pb-24 max-w-6xl mx-auto  text-gray-50">
          ...
          <div className="flex flex-col sm:flex-row justify-between  ">
            <div className="flex flex-col justify-center w-full md:w-3/5  text-left">
              <h1 className="font-GT-Alpina text-[1.9rem] sm:text-6xl">
                ...
                Celo <br />
                <span className="ml-14 xs:ml-16 ms:ml-20">
                  Innovation in <i> Africa</i>
                </span>
              </h1>
              <p className="py-4 w-full  sm:w-5/6 font-sans font-medium text-lg">
              ...
              <div className="flex flex-row gap- sm:gap-6">
                <Button className="bg-Celo-AD-yellow  text-[#090808] hover:bg-Celo-AD-yellow px-4 sm:px-10  w-fit mt-4 text-xs  sm:text-base">
                  Join our community
                </Button>
                <Button className="bg-trasparent px-8 ms:px-10 w-fit mt-4 hover:bg-transparent text-xs  sm:text-base">
                  Incubator program{" "}
                  <img
                    src="./cheron-left-icon.png"
                    className="ml-2"
                    alt="left-icon"
                  />
                </Button>
            ...
            <div className="w-2/5 order-first md:order-last mb-12 md:mb-0">
