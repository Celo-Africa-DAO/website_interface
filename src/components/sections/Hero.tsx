...
const Hero = () => {
    ...
    return (
        <div id='home' className=" bg-Celo-AD-primary text-[#0C0C0C] pt-10 md:pt-20 ">
            <Section>
                    ...
                    <div className='flex flex-col sm:flex-row justify-center  md:justify-between  '>
                        <div className='flex flex-col justify-center  w-full md:w-3/5 text-center md:text-left'>
                            <div className='flex flex-col justify-center font-gt-alpina-trial text-[2.8rem] sm:text-6xl text-[#0C0C0C]'>
                                <p className='font-light md:text-left'><i>Scaling</i></p>
                            ...
                            <div className='md:hidden flex  my-12 sm:mb-12 md:mb-0 text-center justify-center '>
                                <img src="./CAD-hero.png" alt="Celo_Africa_DAO" className='w-100 h-80' />
                            </div>
                            <p className='text-[#565656] font-Inter pb-8 md:py-8 w-full  sm:w-4/6 font-sans      text-base sm:text-lg'>A decentralized autonomous organization dedicated
                                to fostering the growth and adoption of the CELO
                                blockchain  across the Africa.
                            </p>
                            <div className='flex flex-row gap-4 justify-center md:justify-start'>
                                <Button
                                    className=" rounded-[100px] bg-Celo-AD-yellow hover:bg-Celo-AD-yellow/75 text-[#090808] hover:bg-Celo-AD-yellow px-4 sm:px-10  w-fit mt-4 text-xs  sm:text-base"
                                >
                                    Join our community
                                </Button>
                                <Button className="bg-trasparent text-[#090808] border p-1  w-fit mt-4 hover:bg-transparent text-xs  sm:text-base"> <span className='px-4'>Incubator program</span>
