                ...
                <div className='mx-6 xl:mx-0'>
                    <div className='flex flex-col sm:flex-row justify-between  '>
                        <div className='flex flex-col justify-center w-full md:w-3/5  text-left'>
                            ...
                            <p className='py-4 w-full  sm:w-5/6 font-sans font-medium text-lg'>A decentralized autonomous organization dedicated
                                to fostering the growth and adoption of the CELO
                                blockchain  across the Africa.
                            </p>
                            <div className='flex flex-row gap- sm:gap-6'>
                                <Button
                                    className="bg-Celo-AD-yellow  text-[#090808] hover:bg-Celo-AD-yellow px-4 sm:px-10  w-fit mt-4 text-xs  sm:text-base"
                                >
                                    Join our community
                                </Button>
